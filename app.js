...
const uri = "mongodb+srv://temka:Tz20020325.k1ohz.mongodb.net/shalgalt?retryWrites=true&w=majority";
...
app.post("/", function(req, res) {
    ...
    client.connect((error, result ) =>{
        const collection = client.db("shalgalt").collection("list");
        collection.insertOne({id: 1, taskTitle: "TmyTask", insertdate: Date.now(), isCompleted: true}).then(result => { console.log(result)}).catch(error=>console.error(error));
        client.close();
    })
